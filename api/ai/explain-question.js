...
Đáp án chuẩn: "${answerKey}"
Lựa chọn / Bài làm của học sinh: "${studentAnswer || 'Chưa chọn'}"

Yêu cầu QUAN TRỌNG:
- TUYỆT ĐỐI KHÔNG DÙNG KÝ TỰ ** (dấu hai dấu sao) TRONG BÀI VIẾT.
- Nêu rõ tên lựa chọn của học sinh (ví dụ "so" hoặc "because", không ghi A, B, C hay D).

Yêu cầu trình bày gồm 4 phần rõ ràng:
1. 🌐 Dịch nghĩa câu hỏi: Dịch câu hỏi sang tiếng Việt hoàn chỉnh.
2. ✅ Tại sao đáp án "${answerKey}" ĐÚNG: Giải thích cấu trúc ngữ pháp và ý nghĩa tại sao từ/mệnh đề này đúng.
3. ❌ Tại sao các phương án khác SAI: Nêu rõ lý do các phương án lựa chọn khác không phù hợp.
4. 💡 Mẹo làm bài nhanh: Đưa ra dấu hiệu nhận biết (dấu phẩy, liên từ...) giúp khoanh đúng trong 3 giây.`;
